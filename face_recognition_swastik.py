...
if add_selectbox == "Project features":
    ...
    im=cv2.imread("/Users/lakshmipriya/Desktop/project/swastik/face.jpg")
        ...
        if fg_image is not None:
            ...
            if add_bg == "Image of your choice":
                ...
                add_ib_bg = st.sidebar.selectbox(
                    ...
                    ("lion","night","lantern","random")
                )
                if add_ib_bg == "lion":
                    bg_image = cv2.imread("/Users/lakshmipriya/Desktop/project/swastik/lion.jpg")
                ...
                elif add_ib_bg == "night":
                    bg_image = cv2.imread("/Users/lakshmipriya/Desktop/project/swastik/night.jpg")
                    bg_image = cv2.cvtColor(bg_image, cv2.COLOR_RGB2BGR)
                    if bg_image is not None: 
                        st.sidebar.image(bg_image)
                        bimage = cv2.resize(bg_image, (fimage.shape[1], fimage.shape[0]))
                ...
                elif add_ib_bg == "lantern":
                    bg_image = cv2.imread("/Users/lakshmipriya/Desktop/project/swastik/lantern.jpg")
                    bg_image = cv2.cvtColor(bg_image, cv2.COLOR_RGB2BGR)
                    if bg_image is not None: 
                        st.sidebar.image(bg_image)
                        bimage = cv2.resize(bg_image, (fimage.shape[1], fimage.shape[0]))
                ...
                elif add_ib_bg == "random":
                    bg_image = cv2.imread("/Users/lakshmipriya/Desktop/project/swastik/random.jpg")
                    bg_image = cv2.cvtColor(bg_image, cv2.COLOR_RGB2BGR)
                    if bg_image is not None: 
                        st.sidebar.image(bg_image)
                        bimage = cv2.resize(bg_image, (fimage.shape[1], fimage.shape[0]))
